var util = require('util'),
    ...
    installer = require('@webosose/ares-cli/lib/install');
...
var gdbserverPath = "/media/cryptofs/apps/usr/palm/services/com.palmdts.devmode.service/binaries-armv71/opt/devmode/usr/bin/gdbserver";
    ...
    var gdbserver = {
        ...
        run: function(options, params, next) {
            ...
            function _launchGdbserver(prefixEnv, next) {
                ...
                var cmdRunGdbserver;
                if (appId) {
                    cmdRunGdbserver = util.format(format, gdbserverPath, this.port, path.join(prefixAppPath, appId, this.execName));
                } else if (svcId) {
                    cmdRunGdbserver = util.format(format, gdbserverPath, this.port, path.join(prefixServicePath, svcId, this.execName));
                }
